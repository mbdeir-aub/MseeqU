...
namespace QuizTester
{
    class Program
    {
        ...
        static string FileNameAndPath                            = Environment.GetEnvironmentVariable("Storage_QuizFile");
        
        static void Main(string[] args)
        {
            if (string.IsNullOrWhiteSpace(FileNameAndPath)) FileNameAndPath = "test.txt";
